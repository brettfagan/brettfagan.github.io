function About() {
  return (
    <section id="about" className="py-18 max-[680px]:py-14">
      <div className="w-[min(1080px,92%)] mx-auto">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 py-[0.7rem] px-[1.1rem] rounded-[0.55rem] border no-underline font-semibold transition-transform duration-200 hover:-translate-y-px bg-[#e9eefb] text-[#20305c] border-[#ccd7f2] dark:bg-secondary dark:text-secondary-foreground dark:border-border"
        >
