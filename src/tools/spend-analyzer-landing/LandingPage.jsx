...
const T = {
  ...
  bgCard2:   '#0e1018',
  border:    '#1d2233',
  borderHov: 'rgba(16,217,160,0.28)',
  jade:      '#10d9a0',
  jadeDim:   '#0bbf8b',
  jadeGlow:  'rgba(16,217,160,0.15)',
  text:      '#e4eaf4',
  textMuted: '#5e6e8a',
  textDim:   '#8a9ab5',
};
...
function Pill({ children }) {
  return (
    <div style={{
      ...
      background: `${T.jade}12`, border: `1px solid ${T.jade}28`,
...
function HeroDashboard() {
  ...
  return (
    <div style={{
      ...
      borderRadius: '14px',
      overflow: 'hidden',
      boxShadow: '0 32px 80px rgba(0,0,0,0.65), 0 0 0 1px rgba(255,255,255,0.035)',
      width: '100%',
      maxWidth: '540px',
    }}>
      {/* Window chrome */}
      <div style={{
        ...
        <div style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '11px', color: T.textMuted }}>
            spend-analyzer · March 2025
          </span>
        </div>
        <div style={{ width: 60 }} />
      </div>
      ...
      <div style={{
        ...
        {['Analyzer', 'My Spending', 'My Budget'].map((tab, i) => (
          <span key={tab} style={{
            ...
            fontSize: '12px',
            padding: '9px 12px',
            color: i === 0 ? T.jade : T.textMuted,
            borderBottom: i === 0 ? `2px solid ${T.jade}` : '2px solid transparent',
            cursor: 'default',
            whiteSpace: 'nowrap',
          }}>
            {tab}
      ...
      <div style={{ padding: '14px' }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '5px' }}>
            {legend.map(l => (
              <div key={l.label} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <span style={{ flex: 1, fontSize: '10px', color: T.textDim, fontFamily: "'DM Sans', sans-serif" }}>{l.label}</span>
                <div style={{ width: `${l.pct * 1.1}px`, height: '3px', background: l.color, borderRadius: '2px', opacity: 0.7 }} />
                <span style={{ fontSize: '10px', fontWeight: 600, color: T.text, fontFamily: "'DM Sans', sans-serif", minWidth: '34px', textAlign: 'right' }}>
                  {l.amt}
                </span>
              </div>
            ))}
        ...
        <div style={{ border: `1px solid ${T.border}`, borderRadius: '8px', overflow: 'hidden' }}>
          <div style={{
            ...
            <span style={{ flex: 1, fontSize: '9px', color: T.textMuted, fontFamily: "'DM Sans', sans-serif", letterSpacing: '0.08em', textTransform: 'uppercase' }}>Merchant</span>
            <span style={{ fontSize: '9px', color: T.textMuted, fontFamily: "'DM Sans', sans-serif", letterSpacing: '0.08em', textTransform: 'uppercase', marginRight: '48px' }}>Category</span>
            <span style={{ fontSize: '9px', color: T.textMuted, fontFamily: "'DM Sans', sans-serif", letterSpacing: '0.08em', textTransform: 'uppercase', minWidth: '44px', textAlign: 'right' }}>Amount</span>
          </div>
          {txns.map((t, i) => (
            <div key={i} style={{
              display: 'flex',
              ...
              <span style={{ flex: 1, fontSize: '11px', color: T.text, fontFamily: "'DM Sans', sans-serif", whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{t.name}</span>
              <span style={{
              ...
              <span style={{ fontSize: '11px', color: T.text, fontFamily: "'DM Sans', sans-serif", flexShrink: 0, minWidth: '50px', textAlign: 'right' }}>{t.amt}</span>
              <span style={{ fontSize: '9px', color: T.textMuted, fontFamily: "'DM Sans', sans-serif", flexShrink: 0, minWidth: '28px', textAlign: 'right' }}>{t.date}</span>
            </div>
          ))}
        </div>
      </div>
...
function CategorizationMockup() {
  return (
    <div style={{ padding: '11px', background: '#0e1017', borderRadius: '7px', border: `1px solid ${T.border}` }}>
      {[
        ...
        <div key={i} style={{
          ...
          <span style={{ flex: 1, fontSize: '10px', color: T.text, fontFamily: "'DM Sans', sans-serif", whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{t.name}</span>
          ...
          <span style={{ fontSize: '10px', color: T.text, fontFamily: "'DM Sans', sans-serif", flexShrink: 0 }}>{t.amt}</span>
        </div>
      ))}
    </div>
  );
...
function ChartMockup() {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '11px', background: '#0e1017', borderRadius: '7px', border: `1px solid ${T.border}` }}>
      <div style={{ position: 'relative', width: '64px', height: '64px', flexShrink: 0 }}>
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ fontSize: '9px', color: T.textMuted, fontFamily: "'DM Sans', sans-serif", textAlign: 'center' }}>Mar<br />2025</div>
        </div>
      </div>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '6px' }}>
        {slices.map(s => (
          <div key={s.l} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <span style={{ width: '52px', fontSize: '10px', color: T.textDim, fontFamily: "'DM Sans', sans-serif" }}>{s.l}</span>
            ...
            <span style={{ fontSize: '9px', color: T.textMuted, fontFamily: "'DM Sans', sans-serif", minWidth: '22px', textAlign: 'right' }}>{s.p}%</span>
          </div>
        ))}
      </div>
    </div>
...
function BudgetMockup() {
  ...
  return (
    <div style={{ padding: '11px', background: '#0e1017', borderRadius: '7px', border: `1px solid ${T.border}`, display: 'flex', flexDirection: 'column', gap: '10px' }}>
      {items.map(item => {
        ...
        return (
          <div key={item.label}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
              <span style={{ fontSize: '10px', color: T.textDim, fontFamily: "'DM Sans', sans-serif" }}>{item.label}</span>
              <span style={{ fontSize: '10px', fontFamily: "'DM Sans', sans-serif", color: over ? '#ef4444' : T.textMuted }}>
                ${item.spent} <span style={{ color: T.textMuted }}>/ ${item.budget}</span>
              </span>
            </div>
...
function ConnectionsMockup() {
  return (
    <div style={{ display: 'flex', gap: '8px', padding: '11px', background: '#0e1017', borderRadius: '7px', border: `1px solid ${T.border}` }}>
      {[
        ...
        <div key={c.label} style={{
          ...
          background: c.active ? `${T.jade}0c` : '#101318',
          border: `1px solid ${c.active ? `${T.jade}28` : T.border}`,
          borderRadius: '8px',
          cursor: 'default',
        }}>
          <div style={{ fontSize: '18px', marginBottom: '5px' }}>{c.icon}</div>
          <div style={{ fontSize: '10px', fontWeight: 600, color: c.active ? T.jade : T.text, fontFamily: "'DM Sans', sans-serif" }}>{c.label}</div>
          <div style={{ fontSize: '9px', color: T.textMuted, fontFamily: "'DM Sans', sans-serif", marginTop: '1px' }}>{c.sub}</div>
        </div>
      ))}
    </div>
  );
...
function SharingMockup() {
  return (
    <div style={{ padding: '14px 11px', background: '#0e1017', borderRadius: '7px', border: `1px solid ${T.border}`, display: 'flex', alignItems: 'center', gap: '12px' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '3px' }}>
        <div style={{ height: '1px', background: `linear-gradient(90deg, ${T.jade}60, ${T.jade}20)` }} />
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <span style={{ fontSize: '11px', color: T.jade, fontFamily: "'DM Sans', sans-serif" }}>read-only →</span>
        </div>
        <div style={{ height: '1px', background: `linear-gradient(90deg, ${T.jade}20, ${T.jade}60)` }} />
      </div>
...
function MultiCardMockup() {
  ...
  return (
    <div style={{ padding: '11px', background: '#0e1017', borderRadius: '7px', border: `1px solid ${T.border}`, position: 'relative', height: '72px', overflow: 'hidden' }}>
      {cards.map((c, i) => (
...
const FEATURES = [
  {
    ...
    desc: 'Transactions are categorized automatically by merchant name. Add custom regex rules to fine-tune any edge case.',
    Mockup: CategorizationMockup,
  },
  {
    icon: '📊',
    title: 'Spending Charts',
    desc: 'Visual breakdowns by category — donut chart, bar totals, subcategory drill-down. See where money actually goes.',
    Mockup: ChartMockup,
  },
  {
    icon: '🎯',
    title: 'Budget Tracking',
    desc: 'Set monthly budgets per category. Remaining amounts update live as you import new transactions.',
    Mockup: BudgetMockup,
  },
  {
    icon: '🔗',
    title: 'Flexible Connections',
    desc: 'Connect your bank directly via Plaid for auto-sync, or upload CSV exports from any card issuer.',
    Mockup: ConnectionsMockup,
  },
  {
    icon: '👥',
    title: 'Partner Sharing',
    desc: 'Invite a partner with read-only access. Great for couples who want shared financial visibility without shared logins.',
    Mockup: SharingMockup,
  },
  {
    icon: '💳',
    title: 'Multi-Card Support',
    desc: 'Track Fidelity, Barclays, Chase, Verizon, and more — all in a single unified spending view.',
    Mockup: MultiCardMockup,
  },
];
  ...
  return (
    <motion.nav
      ...
      style={{
        ...
        background: scrolled ? 'rgba(12, 14, 20, 0.86)' : 'transparent',
  ...
  return (
    <section id="top" style={{ paddingTop: '132px', paddingBottom: '96px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        background: `radial-gradient(ellipse at center, ${T.jade}0e 0%, transparent 62%)`,
        pointerEvents: 'none',
      }} />
      ...
      <div style={{
        ...
        background: `radial-gradient(ellipse at center, rgba(37,99,235,0.07) 0%, transparent 62%)`,
        pointerEvents: 'none',
      }} />
      ...
      <div style={{ maxWidth: '1120px', margin: '0 auto', padding: '0 28px', display: 'flex', alignItems: 'center', gap: '56px' }}>
        ...
        <div style={{ flex: '0 0 auto', maxWidth: '460px' }}>
          ...
          >
            ...
            <span style={{
              color: T.jade,
              background: `linear-gradient(90deg, ${T.jade}, #00c4ff)`,
          ...
          >
            <a href="/tools/spend-analyzer/" style={{
              ...
              alignItems: 'center',
              gap: '7px',
              boxShadow: `0 4px 28px ${T.jade}28`,
              transition: 'all 0.2s',
            }}
            onMouseEnter={e => { e.currentTarget.style.background = T.jadeDim; e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = `0 8px 32px ${T.jade}30`; }}
            onMouseLeave={e => { e.currentTarget.style.background = T.jade; e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = `0 4px 28px ${T.jade}28`; }}>
              Try the App →
            </a>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '28px' }}
          >
            <div style={{ display: 'flex', gap: '-4px' }}>
              {['#3b82f6', '#10b981', '#f59e0b', '#ec4899'].map((c, i) => (
                <div key={i} style={{ width: 22, height: 22, borderRadius: '50%', background: c, border: '2px solid #0c0e14', marginLeft: i > 0 ? '-6px' : '0', zIndex: 4 - i, position: 'relative' }} />
              ))}
            </div>
...
function FeaturesSection() {
  ...
  return (
    <section id="features" ref={ref} style={{ padding: '96px 0', position: 'relative' }}>
      {/* Divider glow */}
      <div style={{
        position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)',
        width: '300px', height: '1px',
        background: `linear-gradient(90deg, transparent, ${T.jade}35, transparent)`,
      }} />
      ...
      <div style={{ maxWidth: '1120px', margin: '0 auto', padding: '0 28px' }}>
        ...
        >
          ...
          <motion.p
            variants={fadeUp}
            style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '16px', color: T.textMuted, maxWidth: '460px', margin: '0 auto', lineHeight: 1.72 }}
          >
          ...
          {FEATURES.map(f => (
            <motion.div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = `0 12px 40px rgba(0,0,0,0.35), 0 0 0 1px ${T.jade}14`;
              }}
              onMouseLeave={e => {
  ...
  const steps = [
    {
      ...
      desc: 'Link your bank via Plaid for automatic syncing, or drag-and-drop a CSV export from any card issuer.',
    },
    {
      num: '02',
      icon: '⚡',
      title: 'Auto-Categorize',
      desc: 'Every transaction is instantly assigned a category. Refine with custom rules to match your exact workflow.',
    },
    {
      num: '03',
      icon: '📈',
      title: 'Analyze & Budget',
      desc: 'Explore interactive charts, drill into subcategories, set monthly budgets, and track your progress.',
    },
  ];

  return (
    <section id="how-it-works" ref={ref} style={{ padding: '96px 0', position: 'relative' }}>
      <div style={{
        position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)',
        width: '300px', height: '1px',
        background: `linear-gradient(90deg, transparent, ${T.jade}35, transparent)`,
      ...
      <div style={{ maxWidth: '1120px', margin: '0 auto', padding: '0 28px' }}>
        ...
        >
          ...
          <div style={{
            ...
            right: 'calc(16.7% + 8px)',
            height: '1px',
            background: `linear-gradient(90deg, ${T.jade}35 0%, ${T.jade}35 100%)`,
            pointerEvents: 'none',
            zIndex: 0,
          }} />
          ...
          {steps.map((s) => (
            ...
            >
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '14px', color: T.textMuted, lineHeight: 1.72 }}>
                {s.desc}
              </p>
            </motion.div>
          ))}
    ...
    <section ref={ref} style={{ padding: '80px 0 120px' }}>
      <div style={{ maxWidth: '1120px', margin: '0 auto', padding: '0 28px' }}>
        ...
        >
          ...
          <div style={{
            position: 'absolute', inset: 0,
            background: `radial-gradient(ellipse at 50% -20%, ${T.jade}0d 0%, transparent 65%)`,
            pointerEvents: 'none',
          }} />
          {/* Top border accent */}
          <div style={{
            position: 'absolute', top: 0, left: '25%', right: '25%', height: '1px',
            background: `linear-gradient(90deg, transparent, ${T.jade}55, transparent)`,
          }} />
...
function Footer() {
  return (
    <footer style={{ borderTop: `1px solid ${T.border}`, padding: '28px 28px' }}>
      <div style={{ maxWidth: '1120px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          {[['/', 'Portfolio'], ['/tools/spend-analyzer/', 'Open App']].map(([href, label]) => (
            <a key={label} href={href} style={{
              fontFamily: "'DM Sans', sans-serif", fontSize: '13px', color: T.textMuted, textDecoration: 'none', transition: 'color 0.15s',
            }}
            onMouseEnter={e => { e.target.style.color = T.text; }}
            onMouseLeave={e => { e.target.style.color = T.textMuted; }}>
              {label}
...
export default function LandingPage() {
  return (
    <div style={{
      ...
      minHeight: '100vh',
      color: T.text,
      backgroundImage: 'radial-gradient(circle, #1b2238 1px, transparent 1px)',
